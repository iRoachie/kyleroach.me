  ...
  <Footer>
    <Container>
      <div className="pb-4 flex sm:justify-end">
        ...
        <FooterIcon
          href="https://www.linkedin.com/in/kyroach"
        ...
        <FooterIcon
          href="https://github.com/iRoachie"
        ...
        <FooterIcon
          href="mailto:kroach.work@gmail.com?subject=Let's Talk"
          aria-label="Send me an email to talk about potential jobs"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 512 512"
      ...
      <div className="sm:flex justify-between text-white">
        <FooterText>
          {new Date().getFullYear()} Kyle Roach, All rights reserved.
        </FooterText>
